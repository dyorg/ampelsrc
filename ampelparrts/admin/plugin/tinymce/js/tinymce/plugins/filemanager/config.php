...
$base_url=URL_SITE; //url base of site if you want only relative url leave empty
$upload_dir = PATH_TINYMCE.'images/'; // path from base_url to upload base dir
$current_path = "../thumbs"; // relative path from filemanager folder to upload files folder
...
$ext_video = array(); //Videos
$ext_music = array(); //Music
