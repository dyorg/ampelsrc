...
?>	
	...
	<div id="tabsConfiguracao" style="width: 100%;">
		...
		<div id="tabs-6">
			<p>
		      	Título: 
			  	<input id="titulo_russo" type="text" name="dados[titulo_russo]" value="<?=htmlentities($class["titulo_russo"])?>" style="width: 100%;" />
			</p>
			<br clear="all" />
			<h1>Descrição</h1>
			<textarea id="titulo_russo" name="dados[titulo_russo]" style="width: 100%; height: 240px;"><?=htmlentities($class["descricao_russo"])?></textarea>
		</div>
