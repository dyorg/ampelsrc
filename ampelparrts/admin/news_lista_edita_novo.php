...
<center><table width=\"500\" border=\"1\" bordercolor=\"#ffffff\" cellpadding=\"0\" cellspacing=\"2\" bgcolor=\"#EAEAEA\">
  <tr>
 ...
 <td valign=\"top\" width=\"20%\"><b><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><a href=editar_news_novo.php?id=$id class=\"link_rodape\"><img src=imagens/btn_alterar1.jpg border=0></a></font></b></td>
...
<hr width="500">
<div align="center"> <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
  </font></strong>

  <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
  Lista de E-mails para usar no Outlook com C&oacute;pia Oculta</font></strong><br>
  <br>
  <?php
include "funcoes.php";
$sql = mysql_query("SELECT * FROM news");
