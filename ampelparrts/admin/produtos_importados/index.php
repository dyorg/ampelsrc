<?php
	...
	$tituloPagina = "Importação - Produtos";
	...
	<script type="text/javascript">
		$("#dataGrid").flexigrid({
			...
			colModel : [
				...
				{display: 'Título', name : 'titulo', width : 200, sortable : true, align: 'left'},
				{display: 'Marca', name : 'marca', width : 200, sortable : true, align: 'left'},
				{display: 'Cód. Visivel', name : 'codigo', width : 200, sortable : true, align: 'left'},
				{display: 'Cód. Invisivel', name : 'codigo_invisivel', width : 400, sortable : true, align: 'left'}
				],
			buttons : [
