<?php
	...
	foreach($dadosBusca as $valor) {
		...
		<row id='".$valor['id']."'>
			...
			<cell><![CDATA[".utf8_encode($valor['titulo'])."]]></cell>
			<cell><![CDATA[".utf8_encode($valor['marca'])."]]></cell>
			<cell><![CDATA[".utf8_encode($valor['codigo'])."]]></cell>
			<cell><![CDATA[".utf8_encode($valor['codigo_invisivel'])."]]></cell>
		</row>";
	}
	$xml.= "</rows>";
	echo $xml;
